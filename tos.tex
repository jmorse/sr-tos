...
\usepackage[top=2in,left=1.5in,bottom=2in,right=1.25in]{geometry}
\usepackage{graphicx}
\usepackage{ctable}
...
\makebox[0.8\textwidth]{\includegraphics[height=1em]{moto.png}\hspace{-3em}\vbox{\vfill{}\small Student Robotics is made possible\\ by our generous sponsors\vfill{}}\hspace{-3em}\includegraphics[height=1em]{ecs.png}}}
\begin{document}
...
The competitors are any 16-18 year olds who are interested in learning
...
has its own page on our website, containing location, schedule and parking details.
...
team's ability. We trust you to decide on a fair balance of how much help to
provide.
